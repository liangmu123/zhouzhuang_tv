...
//  right.toggleFocus();
//}
var hasIndex = EVM.cookie.getValue('bindex');
...
//      pagesize: size
    ...
    getDatas("party/partyMemberAdv", params, function (err, res) {
        ...
        for (var i = 0; i < dataItems.length; i++) {
			...
			str += '<img src='+web_url+dataItems[i].vivid_img+'></div>'
    ...
    mod.action = function (directive) {
        ...
        switch (directive) {
            case 'back':
                ...
                break;
            case 'enter':
            EVM.cookie.setValue('bindex',index);
            var id = document.getElementsByClassName('iactive')[0].getAttribute('data-id');
                   window.location.href = 'dangyuan-xq.html?id='+id;
                break;
        }
        return me;
    };
