...
function getMessage() {
    ...
    getDatas('article/index', params, function (err, res) {
        ...
        str += detailData.content + "</div></div>";
        if(detailData.img !=""){
        	str += "<div class='picBar'><img class='imgs' id='imgs' src='"+ web_url + detailData.img + "' style='float:left;margin-right:15px;width:280px;max-height:400px;'><div class='picIntro'>选择请按确认键放大查看更多图集</div></div>";
        }else{
